...
class PID(object):
    ...
    def __call__(self, input_):
        ...
        # Shortcut when error is within bias
        if -self.bias <= error <= self.bias:
    ...
    @property
    def tunings(self):
        """The tunings used by the controller as a tuple: (Kp, Ki, Kd, bias)"""
        return self.Kp, self.Ki, self.Kd, self.bias

    @tunings.setter
    def tunings(self, tunings):
        """Setter for the PID tunings"""
        self.Kp, self.Ki, self.Kd, self.bias = tunings
